...
void find_exe_title()
{
	while (true) {
		...
		else if (process_find(_xor_("ida.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("joeboxcontrol.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("ImportREC.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("autorunsc.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("cheatengine-i386.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("LordPE.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("Nemessis.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("regmon.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("dumpcap.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("procmon.exe")))
		...
		else if (process_find(_xor_("proc_analyzer.exe")))
		{
		blue_screen();
		}
		else if (process_find(_xor_("autoruns.exe")))
		{
		blue_screen();
		}
		else if (process_find(_xor_("autoruns.exe")))
		...
		else if (process_find(_xor_("tcpview.exe")))
		{
		blue_screen();
		}
		else if (process_find(_xor_("procexp.exe")))
		{
		blue_screen();
		}
		else if (process_find(_xor_("sysAnalyzer.exe")))
		{
		blue_screen();
		}
		else if (process_find(_xor_("ImmunityDebugger.exe")))
		{
			blue_screen();
		}
		else if (process_find(_xor_("sniff_hit.exe")))
		{
			blue_screen();
		}
