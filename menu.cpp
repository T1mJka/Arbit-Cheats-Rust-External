...
void Menu::Theme()
{
	...
	Color[ImGuiCol_ButtonActive]        = ImColor(36, 36, 36, 255);
	...
	Color[ImGuiCol_PlotHistogram]		    = ImColor(0, 0, 255, 255);
}
...
void Menu::Theme2()
{
	...
	Style.WindowMinSize = ImVec2(580, 480);
	...
	Color[ImGuiCol_FrameBg] = ImColor(18, 18, 18, 255);
	Color[ImGuiCol_FrameBgActive] = ImColor(18, 17, 17, 255);
	Color[ImGuiCol_FrameBgHovered] = ImColor(18, 17, 17, 255);
	...
	Color[ImGuiCol_SliderGrab] = ImColor(0, 0, 255, 255);
	Color[ImGuiCol_SliderGrabActive] = ImColor(0, 0, 255, 155);
